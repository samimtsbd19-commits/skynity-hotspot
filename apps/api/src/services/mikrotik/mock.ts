...
export const mockMikrotikService = {
  ...
  getInterfaceList(): NetworkInterface[] {
    ...
    return ifaces.map((i) => ({
      ...
      mtu: i.mtu,
      isUp: i.up,
      txBytes: randInt(1000000000, 50000000000),
      rxBytes: randInt(1000000000, 50000000000),
      txPackets: randInt(1000000, 50000000),
      rxPackets: randInt(1000000, 50000000),
  ...
  getSimpleQueues(): SimpleQueue[] {
    return Array.from({ length: 12 }).map((_, i) => ({
      ...
      txBytes: randInt(1000000, 5000000000),
      rxBytes: randInt(1000000, 5000000000),
      txPackets: randInt(10000, 5000000),
      rxPackets: randInt(10000, 5000000),
  ...
  getHotspotUsers(): HotspotUser[] {
    return Array.from({ length: 10 }).map((_, i) => {
      ...
      return {
        ...
        bytesIn: randInt(100000, 50000000),
        bytesOut: randInt(100000, 50000000),
        disabled: state?.disabled ?? false,
      };
    });
  },
  ...
  getHotspotActiveUsers(): ActiveHotspotUser[] {
    return Array.from({ length: 5 }).map((_, i) => {
      ...
      return {
        ...
        bytesIn: randInt(10000, 5000000),
        bytesOut: randInt(10000, 5000000),
